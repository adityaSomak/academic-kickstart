...
<tbody><tr><td id="nobd" align="left" valign="top"><b>Instructor</b>
    ...
    </td><td id="nobd" valign="top" align="left"> NC241, Nalanda Classroom
...
<p></p>
Weightage: Class-Performance/Viva (8-10%), Mid-Sem and End-Sem (60%), Term Project (30-32%).
<p></p>
...
<li> Retrieval-Augmented Generation (RAG) and Large Language Models</li>
