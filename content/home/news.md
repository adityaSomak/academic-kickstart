...
<i class="fa fa-bullhorn" style="color:red;text-shadow:1px 1px 1px #000;"></i>  <span style="font-weight: bold;">[May 2023]</span> Microsoft: Received the "Accelerate Foundation Models Academic Research" 2023 by Microsoft jointly with Prof. Animesh Mukherjee. This comes with large Azure credits and GPT4 API access. 
<br/>
